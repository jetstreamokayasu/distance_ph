...
trs300_l10_sorted<-sort(trs300_1_10_dist[land10F[1], ])[1:21]
plot(trs300_1_10_dist[land10F[1], ], trs300_1_10_dist[land10F[1], ]*(1-exp(-(trs300_1_10_dist[land10F[1], ]/(trs300_l10_sorted[21] * sqrt(3/2)))^2)), col=2)
points(trs300_1_10_dist[land10F[1], ], trs300_1_10_dist[land10F[1], ])
...
plot(t3orus4_dist[t4_land1[1], ], t3orus4_dist[t4_land1[1], ]*(1-exp(-(t3orus4_dist[t4_land1[1], ]/7)^2)), col=2)
