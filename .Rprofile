...
source('~/R/distance_ph/functions/R6trial.R', encoding = 'UTF-8')
source('~/R/distance_ph/functions/auto_estimate_betti_functions.R', encoding = 'UTF-8')
source('~/R/distance_ph/functions/dist_ch_func.R', encoding = 'UTF-8')
source('~/R/distance_ph/functions/data_generate_func.R', encoding = 'UTF-8')
source('~/R/distance_ph/functions/smooth_landscape_func.R', encoding = 'UTF-8')
